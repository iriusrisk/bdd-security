...
Meta: @id auth_return_redirect @cwe-525-repost @browser_only
Given a new browser instance
...
Meta: @id auth_autocomplete_login_form @cwe-525-autocomplete-form @browser_only
Given a new browser instance
And the login page
...
Meta: @id auth_autocomplete_password @skip @cwe-525 @browser_only
Given a new browser instance
And the login page
...
Meta: @id auth_login_captcha @skip @browser_only
Given a new browser instance
And the default username from: auto-generated/users.table
And an incorrect password
And the user logs in from a fresh login page 4 times
